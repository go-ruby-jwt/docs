# go-ruby-jwt documentation

**Pure-Go, MRI-faithful Ruby jwt (no cgo)**

`go-ruby-jwt/jwt` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `jwt`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `jwt`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-jwt/jwt
```
...
| Repo | What it is |
| --- | --- |
| [`jwt`](https://github.com/go-ruby-jwt/jwt) | the library — Ruby's `jwt` in pure Go |
| [`docs`](https://github.com/go-ruby-jwt/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-jwt.github.io`](https://github.com/go-ruby-jwt/go-ruby-jwt.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-jwt/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-jwt/jwt](https://github.com/go-ruby-jwt/jwt).
