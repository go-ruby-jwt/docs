...
The public API lives at the module root (`github.com/go-ruby-jwt/jwt`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `jwt`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-jwt/jwt](https://pkg.go.dev/github.com/go-ruby-jwt/jwt)**

The module's [README](https://github.com/go-ruby-jwt/jwt#readme) carries worked
