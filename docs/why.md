...
`go-ruby-jwt/jwt` reimplements Ruby's `jwt` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-jwt/jwt` directly, with no Ruby runtime;
